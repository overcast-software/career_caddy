...
- frontend: =@attr triage= on job-post (single object, heavily documented as
  ...
  Seniority / Tech stack / Dislike company) and "type anything" creates
...
** DONE [#A] Scrape-quality gate + profile url_rewrites [api+ai+automation]
CLOSED: [2026-04-23]
...
** DONE [#A] Job-post dedupe — canonical link + content fingerprint [api+frontend]
CLOSED: [2026-04-24]
...
** DONE [#A] Loading-skeleton substates for all parent paths [frontend]
CLOSED: [2026-04-24]
