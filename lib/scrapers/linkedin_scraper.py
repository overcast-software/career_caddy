...
class LinkedInScraper():
    def __init__(self, browser, url: str, credentials: dict = {}, cookies_file='cookies.json'):
        ...
        if button_elements:
            ...
            if button_text == "Apply":
                try:
                    ...
                    if element:
                        print('Element with ID "jobs-apply-button-id" exists on the page.')
                    else:
                        print('Element with ID "jobs-apply-button-id" does not exist on the page.')
                        return None, None
    ...
    async def test_login(self):
        try:
            ...
            if "linkedin.com/uas/login" in self.page.url:
                ...
                user_login_block_selector = "div.member-profile-container div.member-profile-block"
